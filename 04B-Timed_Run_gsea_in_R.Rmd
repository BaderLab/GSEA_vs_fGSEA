...
```{r initialize parameters - gsea jar}
#path to GSEA jar 
...
GSEA started at `r start_time`

GSEA finished at `r end_time`

GSEA total running time `r end_time - start_time`


  

```{r build_em, eval=FALSE, include=FALSE}

## Create an Enrichment map of the top pathways.

rmarkdown::render(input = "07-Create_EM_from_GSEA_results.Rmd",
                    params = list(analysis_name = params$analysis_name,
                                  working_dir = params$working_dir,
                                  output_dir = output_dir,
                                  rnk_file = params$rnk_file,
                                  expression_file = params$exp_file,
                                  cls_file = params$cls_file,
                                  pvalue_thresh = 1.0, qvalue_thresh = 0.05),
                    output_format = "html_document",
                    output_file = paste("gsea_em_creation_results",
                                        ".html",sep="_"),envir = new.env())
```
