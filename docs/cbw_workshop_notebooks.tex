...
\CommentTok{\#gsea\_jar \textless{}{-} params$gsea\_jar {-}{-}\textgreater{} if you want to define parameters for the notebook and run as script you can pass this in as a parameter and set it like this.}
...
\CommentTok{\#working\_dir \textless{}{-} params$working\_dir {-}{-}\textgreater{} if you want to define parameters for the notebook and run as script you can pass this in as a parameter and set it like this.}
...
\CommentTok{\# analysis\_name \textless{}{-} params$analysis\_name {-}{-}\textgreater{} if you want to define parameters for the notebook and run as script you can pass this in as a parameter and set it like this.}
...
\CommentTok{\#rnk\_file \textless{}{-} params$rnk\_file {-}{-}\textgreater{} if you want to define parameters for the notebook and run as script you can pass this in as a parameter and set it like this.}
...
\CommentTok{\#run\_gsea \textless{}{-} params$run\_gsea {-}{-}\textgreater{} if you want to define parameters for the notebook and run as script you can pass this in as a parameter and set it like this.}
