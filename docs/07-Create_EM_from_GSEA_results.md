...
<div class="figure">
<img src="./generated_data/gsea//GSEA_initial_screenshot_network.png" alt="GSEA Enrichment Map" width="100%" />
<p class="caption">(\#fig:network_gsea)GSEA Enrichment Map</p>
</div>
