...
path_to_file <- file.path(cytoscape_dir,paste("GSEA","initial_screenshot_network.png",sep = "_"))
path_to_file_fornotebook <- file.path(output_dir,paste("GSEA","initial_screenshot_network.png",sep = "_" ))
...
```{r network_gsea, echo=FALSE, fig.cap="GSEA Enrichment Map", out.width = '100%'}
